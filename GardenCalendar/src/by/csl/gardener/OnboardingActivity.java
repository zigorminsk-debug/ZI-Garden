...
public class OnboardingActivity extends Activity {
    ...
    static final Slide[] SLIDES = {
        ...
        new Slide("🧺",
                "Схемы, виджеты и обновления",
                "46 культур с индивидуальными схемами посадки и 13 агроприёмов — от обрезки до прививки. Четыре виджета рабочего стола: задачи, погода, сезонные угрозы и памятка дня. Обновления приходят по воздуху прямо из приложения — кнопка на экране «О программе».",
