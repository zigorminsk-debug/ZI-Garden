...
public class OnboardingActivity extends Activity {
    ...
    static final Slide[] SLIDES = {
        ...
        new Slide("🧺",
                ...
                "46 культур с индивидуальными схемами посадки и 39 агроприёмов — от обрезки до прививки. Природный календарь фенологии подскажет сроки: от «копеечного листа» берёзы до черёмуховых холодов. Семь виджетов рабочего стола, обновления приходят по воздуху прямо из приложения.",
